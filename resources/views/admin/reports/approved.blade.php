...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h5>Approved Applications List</h5>
        </div>
        <div class="card-body">
                ...
                <table class="table table-striped table-hover">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th><i class="bi bi-calendar-check"></i> Approved Date</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <div class="mt-3">
                                        <h4>No approved applications found</h4>
                                        <p class="text-muted">There are currently no approved applications.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
